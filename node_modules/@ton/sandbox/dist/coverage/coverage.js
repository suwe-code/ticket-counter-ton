...
const html_1 = require("./view/html");
const text_1 = require("./view/text");
/**
...
class Coverage {
    ...
    static fromJson(data) {
        return new Coverage((0, json_1.coverageFromJson)(data));
    }
    /**
     ...
     */
    toJson() {
        return (0, json_1.coverageToJson)(this.data);
    }
    /**
    ...
    report(format) {
        if (format === "html") {
            return (0, html_1.generateHtmlReport)(this.data);
        }
        if (format === "text") {
            return (0, text_1.generateTextReport)(this.data);
        }
     ...
     */
    summary() {
        return (0, data_1.generateCoverageSummary)(this.data);
    }
    /**
     ...
     */
    mergeWith(...other) {
        return new Coverage((0, data_1.mergeCoverages)(this.data, ...other.map(it => it.data)));
    }
}
