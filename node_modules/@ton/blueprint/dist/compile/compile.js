...
exports.libraryCellFromCode = libraryCellFromCode;
...
function libraryCellFromCode(code) {
    // Pack resulting code hash into library cell
    const libPrep = (0, core_1.beginCell)().storeUint(2, 8).storeBuffer(code.hash()).endCell();
    return new core_1.Cell({ exotic: true, bits: libPrep.bits, refs: libPrep.refs });
}
