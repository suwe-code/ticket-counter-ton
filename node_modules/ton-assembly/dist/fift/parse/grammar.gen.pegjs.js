...
exports.SyntaxError = exports.StartRules = void 0;
...
function peg$parse(input, options) {
    ...
    const peg$c14 = "ELSE<{";
    const peg$c15 = "IFJMP:<{";
    const peg$c16 = "IFNOTJMP:<{";
    const peg$c17 = "WHILE:<{";
    const peg$c18 = "}>DO<{";
    const peg$c19 = "REPEAT:<{";
    const peg$c20 = "UNTIL:<{";
    const peg$c21 = "<{";
    const peg$c22 = "}>c";
    const peg$c23 = "}>s";
    ...
    const peg$c43 = "s()";
    const peg$c44 = "c";
    const peg$c45 = "PROGRAM";
    const peg$c46 = "END>c";
    const peg$c47 = "DO<{";
    const peg$c48 = "<b 0 2 u, b>";
    const peg$c49 = "CALLDICT";
    const peg$c50 = "INLINECALLDICT";
    const peg$c51 = "//";
    const peg$r0 = /^[^"]/;
    ...
    const peg$r7 = /^[a-z]/;
    const peg$r8 = /^[a-z$_%?~.]/;
    const peg$r9 = /^[A-Z0-9_#:]/;
    const peg$r10 = /^[0-9]/;
    const peg$r11 = /^[a-zA-Z0-9$_%?]/;
    const peg$r12 = /^[ \t\r\n]/;
    const peg$r13 = /^[^\r\n]/;
    ...
    const peg$e14 = peg$literalExpectation("IFNOT:<{", false);
    const peg$e15 = peg$literalExpectation("ELSE<{", false);
    const peg$e16 = peg$literalExpectation("IFJMP:<{", false);
    const peg$e17 = peg$literalExpectation("IFNOTJMP:<{", false);
    const peg$e18 = peg$literalExpectation("WHILE:<{", false);
    const peg$e19 = peg$literalExpectation("}>DO<{", false);
    const peg$e20 = peg$literalExpectation("REPEAT:<{", false);
    const peg$e21 = peg$literalExpectation("UNTIL:<{", false);
    const peg$e22 = peg$literalExpectation("<{", false);
    const peg$e23 = peg$literalExpectation("}>c", false);
    const peg$e24 = peg$literalExpectation("}>s", false);
    const peg$e25 = peg$literalExpectation("}>CONT", false);
    const peg$e26 = peg$literalExpectation("x{", false);
    ...
    const peg$e31 = peg$classExpectation(["0", "1"], false, false, false);
    const peg$e32 = peg$literalExpectation("B{", false);
    const peg$e33 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"], "_"], false, false, false);
    const peg$e34 = peg$literalExpectation("<b", false);
    const peg$e35 = peg$literalExpectation("0", false);
    const peg$e36 = peg$literalExpectation("2", false);
    const peg$e37 = peg$literalExpectation("u,", false);
    const peg$e38 = peg$literalExpectation("b>", false);
    ...
    const peg$e43 = peg$classExpectation([["a", "z"]], false, false, false);
    const peg$e44 = peg$classExpectation([["a", "z"], "$", "_", "%", "?", "~", "."], false, false, false);
    const peg$e45 = peg$literalExpectation("-", false);
    const peg$e46 = peg$classExpectation([["A", "Z"], ["0", "9"], "_", "#", ":"], false, false, false);
    const peg$e47 = peg$literalExpectation("l", false);
    const peg$e48 = peg$literalExpectation("0b", false);
    const peg$e49 = peg$literalExpectation("0x", false);
    const peg$e50 = peg$classExpectation([["0", "9"]], false, false, false);
    const peg$e51 = peg$literalExpectation("s", false);
    const peg$e52 = peg$literalExpectation("s(", false);
    const peg$e53 = peg$literalExpectation(")", false);
    const peg$e54 = peg$literalExpectation("s()", false);
    const peg$e55 = peg$literalExpectation("c", false);
    const peg$e56 = peg$literalExpectation("PROGRAM", false);
    const peg$e57 = peg$literalExpectation("END>c", false);
    const peg$e58 = peg$literalExpectation("DO<{", false);
    const peg$e59 = peg$literalExpectation("<b 0 2 u, b>", false);
    const peg$e60 = peg$literalExpectation("CALLDICT", false);
    const peg$e61 = peg$literalExpectation("INLINECALLDICT", false);
    const peg$e62 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "$", "_", "%", "?"], false, false, false);
    const peg$e63 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false, false);
    const peg$e64 = peg$literalExpectation("//", false);
    const peg$e65 = peg$classExpectation(["\r", "\n"], true, false, false);
    ...
    function peg$f16(kind, instructions, else_instructions) {
        return { instructions: else_instructions };
    }
    function peg$f17(kind, instructions, else_block) {
        return { $: "IfStatement", kind, instructions, else_block: else_block ?? undefined };
    }
    function peg$f18(kind, instructions) {
    ...
    function peg$parseFiftAddressNone() {
                                            ...
                                            if (s0 === peg$FAILED) {
                                                ...
                                                if (s0 === peg$FAILED) {
                                                    ...
                                                    if (s0 === peg$FAILED) {
                                                        ...
                                                        if (s0 === peg$FAILED) {
                                                            if (input.substr(peg$currPos, 11) ===
                                                                peg$c16) {
                                                                s0 = peg$c16;
                                                                peg$currPos += 11;
                                                            }
                                                                            ...
                                                                            if (s0 === peg$FAILED) {
                                                                                ...
                                                                                if (s0 ===
                                                                                    ...
                                                                                    if (s0 ===
                                                                                        ...
                                                                                        s0 =
                                                                                            peg$currPos;
                                                                                        if (input.substr(peg$currPos, 14) ===
                                                                                            peg$c50) {
                                                                                            s1 =
                                                                                                peg$c50;
                                                                                            peg$currPos += 14;
...
//# sourceMappingURL=grammar.gen.pegjs.js.map