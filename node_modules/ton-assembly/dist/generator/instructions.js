...
exports.instructions = {
    ...
    TPUSH: effects(cat("tuple", mksimple(0x6f8c, 16, `exec_tuple_push`)), (0, exports.Tuple)()),
    TPOP: effects(cat("tuple", mksimple(0x6f8d, 16, `exec_tuple_pop`)), (0, exports.Tuple)()),
    ...
    THROWANY: effects(cat("exception", mksimple(0xf2f0, 16, `exec_throw_any`)), (0, exports.AlwaysThrow)()),
    THROWARGANY: effects(cat("exception", mksimple(0xf2f1, 16, `exec_throw_any`)), (0, exports.AlwaysThrow)()),
    THROWANYIFNOT: effects(cat("exception", mksimple(0xf2f4, 16, `exec_throw_any`)), (0, exports.CanThrow)()),
    THROWARGANYIFNOT: effects(cat("exception", mksimple(0xf2f5, 16, `exec_throw_any`)), (0, exports.CanThrow)()),
    ...
    ADDINT: cat("add_mul", mkfixedn(0xa6, 8, 8, (0, exports.seq)(int8), `exec_add_tinyint8(_1, _2, false)`)),
    MULINT: cat("add_mul", mkfixedn(0xa7, 8, 8, (0, exports.seq)(int8), `exec_mul_tinyint8(_1, _2, false)`)),
    QADDINT: cat("add_mul", mkfixedn(0xb7a6, 16, 8, (0, exports.seq)(int8), `exec_add_tinyint8(_1, _2, true)`)),
    QMULINT: cat("add_mul", mkfixedn(0xb7a7, 16, 8, (0, exports.seq)(int8), `exec_mul_tinyint8(_1, _2, true)`)),
    EQINT: cat("int_cmp", mkfixedn(0xc0, 8, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x878, false, 'EQ')`)),
    LESSINT: cat("int_cmp", mkfixedn(0xc1, 8, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x887, false, 'LESS')`)),
    GTINT: cat("int_cmp", mkfixedn(0xc2, 8, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x788, false, 'GT')`)),
    NEQINT: cat("int_cmp", mkfixedn(0xc3, 8, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x787, false, 'NEQ')`)),
    QEQINT: cat("int_cmp", mkfixedn(0xb7c0, 16, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x878, true, 'QEQ')`)),
    QLESSINT: cat("int_cmp", mkfixedn(0xb7c1, 16, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x887, true, 'QLESS')`)),
    QGTINT: cat("int_cmp", mkfixedn(0xb7c2, 16, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x788, true, 'QGT')`)),
    QNEQINT: cat("int_cmp", mkfixedn(0xb7c3, 16, 8, (0, exports.seq)(int8), `exec_cmp_int(_1, _2, 0x787, true, 'QNEQ')`)),
    PUSHPOW2DEC: cat("int_const", mkfixedn(0x84, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_push_pow2dec`)),
    PUSHNEGPOW2: cat("int_const", mkfixedn(0x85, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_push_negpow2`)),
    FITS: effects(cat("shift_logic", mkfixedn(0xb4, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_fits_tinyint8(_1, _2, false)`)), (0, exports.CanThrow)()),
    UFITS: effects(cat("shift_logic", mkfixedn(0xb5, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_ufits_tinyint8(_1, _2, false)`)), (0, exports.CanThrow)()),
    QFITS: cat("shift_logic", mkfixedn(0xb7b4, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_fits_tinyint8(_1, _2, true)`)),
    QUFITS: cat("shift_logic", mkfixedn(0xb7b5, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_ufits_tinyint8(_1, _2, true)`)),
    SETCONTCTRMANY: version(9, cat("continuation_change", mkfixedn(0xede3, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_setcont_ctr_many`))),
    CALLCCARGS: cat("continuation_jump", mkfixedn(0xdb36, 16, 8, (0, exports.seq)(uint4, uint4), `exec_callcc_args`)),
    TRYARGS: cat("exception", mkfixedn(0xf3, 8, 8, (0, exports.seq)(uint4, uint4), `exec_try`)),
    PLDREFIDX: cat("cell_deserialize", mkfixedn(0xd74c >> 2, 14, 2, (0, exports.seq)(uint2), `exec_preload_ref_fixed`)),
    CHASHI: version(6, cat("cell_deserialize", mkfixedn(0xd768 >> 2, 14, 2, (0, exports.seq)(uint2), `exec_cell_hash_i(_1, _2, false)`))),
    CDEPTHI: version(6, cat("cell_deserialize", mkfixedn(0xd76c >> 2, 14, 2, (0, exports.seq)(uint2), `exec_cell_depth_i(_1, _2, false)`))),
    JMPDICT: cat("continuation_dict_jump", mkfixedn(0xf14 >> 2, 10, 14, (0, exports.seq)(uint14), `exec_jmpdict`)),
    PREPAREDICT: cat("continuation_dict_jump", mkfixedn(0xf18 >> 2, 10, 14, (0, exports.seq)(uint14), `exec_preparedict`)),
    THROWARG: effects(cat("exception", mkfixedn(0xf2c8 >> 3, 13, 11, (0, exports.seq)(uint11), `exec_throw_arg_fixed(_1, _2, 0x7ff, 0)`)), (0, exports.CanThrow)()),
    THROWARGIF: effects(cat("exception", mkfixedn(0xf2d8 >> 3, 13, 11, (0, exports.seq)(uint11), `exec_throw_arg_fixed(_1, _2, 0x7ff, 3)`)), (0, exports.CanThrow)()),
    THROWARGIFNOT: effects(cat("exception", mkfixedn(0xf2e8 >> 3, 13, 11, (0, exports.seq)(uint11), `exec_throw_arg_fixed(_1, _2, 0x7ff, 2)`)), (0, exports.CanThrow)()),
    JMPXARGS: cat("continuation_jump", mkfixedn(0xdb1, 12, 4, (0, exports.seq)(uint4), `exec_jmpx_args`)),
    RETARGS: cat("continuation_jump", mkfixedn(0xdb2, 12, 4, (0, exports.seq)(uint4), `exec_ret_args`)),
    RETURNARGS: cat("continuation_change", mkfixedn(0xed0, 12, 4, (0, exports.seq)(uint4), `exec_return_args`)),
    BLKDROP: cat("stack", mkfixedn(0x5f0, 12, 4, (0, exports.seq)(uint4), `exec_blkdrop`)),
    TUPLE: effects(cat("tuple", mkfixedn(0x6f0, 12, 4, (0, exports.seq)(uint4), `exec_mktuple`)), (0, exports.Tuple)()),
    INDEX: cat("tuple", mkfixedn(0x6f1, 12, 4, (0, exports.seq)(uint4), `exec_tuple_index`)),
    UNTUPLE: effects(cat("tuple", mkfixedn(0x6f2, 12, 4, (0, exports.seq)(uint4), `exec_untuple`)), (0, exports.Tuple)()),
    UNPACKFIRST: effects(cat("tuple", mkfixedn(0x6f3, 12, 4, (0, exports.seq)(uint4), `exec_untuple_first`)), (0, exports.Tuple)()),
    EXPLODE: effects(cat("tuple", mkfixedn(0x6f4, 12, 4, (0, exports.seq)(uint4), `exec_explode_tuple`)), (0, exports.Tuple)()),
    SETINDEX: effects(cat("tuple", mkfixedn(0x6f5, 12, 4, (0, exports.seq)(uint4), `exec_tuple_set_index`)), (0, exports.Tuple)()),
    INDEXQ: cat("tuple", mkfixedn(0x6f6, 12, 4, (0, exports.seq)(uint4), `exec_tuple_quiet_index`)),
    SETINDEXQ: effects(cat("tuple", mkfixedn(0x6f7, 12, 4, (0, exports.seq)(uint4), `exec_tuple_quiet_set_index`)), (0, exports.Tuple)()),
    XC2PU: cat("stack", mkfixedn(0x541, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4), (0, exports.stack)(4)), `exec_xc2pu`)),
    XCPU2: cat("stack", mkfixedn(0x543, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4), (0, exports.stack)(4)), `exec_xcpu2`)),
    PUSH3: cat("stack", mkfixedn(0x547, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4), (0, exports.stack)(4)), `exec_push3`)),
    XCHG2: cat("stack", mkfixedn(0x50, 8, 8, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4)), `exec_xchg2`)),
    XCPU: cat("stack", mkfixedn(0x51, 8, 8, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4)), `exec_xcpu`)),
    PUSH2: cat("stack", mkfixedn(0x53, 8, 8, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4)), `exec_push2`)),
    PUXC: cat("stack", mkfixedn(0x52, 8, 8, (0, exports.seq)((0, exports.stack)(4), (0, exports.delta)(-1, (0, exports.stack)(4))), `exec_puxc`)),
    XCPUXC: cat("stack", mkfixedn(0x542, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4), (0, exports.delta)(-1, (0, exports.stack)(4))), `exec_xcpuxc`)),
    PUXC2: cat("stack", mkfixedn(0x544, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.delta)(-1, (0, exports.stack)(4)), (0, exports.delta)(-1, (0, exports.stack)(4))), `exec_puxc2`)),
    PUXCPU: cat("stack", mkfixedn(0x545, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.delta)(-1, (0, exports.stack)(4)), (0, exports.delta)(-1, (0, exports.stack)(4))), `exec_puxcpu`)),
    PU2XC: cat("stack", mkfixedn(0x546, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.delta)(-1, (0, exports.stack)(4)), (0, exports.delta)(-2, (0, exports.stack)(4))), `exec_pu2xc`)),
    BLKSWAP: cat("stack", mkfixedn(0x55, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint4), (0, exports.delta)(1, uint4)), `exec_blkswap`)),
    REVERSE: cat("stack", mkfixedn(0x5e, 8, 8, (0, exports.seq)((0, exports.delta)(2, uint4), uint4), `exec_reverse`)),
    SETCONTARGS: cat("continuation_change", mkfixedn(0xec, 8, 8, (0, exports.seq)(uint4, (0, exports.delta)(-1, uint4)), `exec_setcontargs`)),
    BLESSARGS: cat("continuation_change", mkfixedn(0xee, 8, 8, (0, exports.seq)(uint4, (0, exports.delta)(-1, uint4)), `exec_bless_args`)),
    STIR: cat("cell_serialize", mkfixedn(0xcf0a, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    STUR: cat("cell_serialize", mkfixedn(0xcf0b, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    STIQ: cat("cell_serialize", mkfixedn(0xcf0c, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    STUQ: cat("cell_serialize", mkfixedn(0xcf0d, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    STIRQ: cat("cell_serialize", mkfixedn(0xcf0e, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    STURQ: cat("cell_serialize", mkfixedn(0xcf0f, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    PLDI: cat("cell_deserialize", mkfixedn(0xd70a, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    PLDU: cat("cell_deserialize", mkfixedn(0xd70b, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    LDIQ: cat("cell_deserialize", mkfixedn(0xd70c, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    LDUQ: cat("cell_deserialize", mkfixedn(0xd70d, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    PLDIQ: cat("cell_deserialize", mkfixedn(0xd70e, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    PLDUQ: cat("cell_deserialize", mkfixedn(0xd70f, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    PLDUZ: cat("cell_deserialize", mkfixedn(0xd710 >> 3, 13, 3, (0, exports.seq)(exports.plduzArg), `exec_preload_uint_fixed_0e`)),
    PLDSLICE: cat("cell_deserialize", mkfixedn(0xd71d, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_slice_fixed2`)),
    LDSLICEQ: cat("cell_deserialize", mkfixedn(0xd71e, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_slice_fixed2`)),
    PLDSLICEQ: cat("cell_deserialize", mkfixedn(0xd71f, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_slice_fixed2`)),
    IFBITJMP: cat("continuation_cond", mkfixedn(0xe380 >> 5, 11, 5, (0, exports.seq)(uint5), `exec_if_bit_jmp`)),
    IFNBITJMP: cat("continuation_cond", mkfixedn(0xe3a0 >> 5, 11, 5, (0, exports.seq)(uint5), `exec_if_bit_jmp`)),
    INDEX2: cat("tuple", mkfixedn(0x6fb, 12, 4, (0, exports.seq)(uint2, uint2), `exec_tuple_index2`)),
    INDEX3: cat("tuple", mkfixedn(0x6fc >> 2, 10, 6, (0, exports.seq)(uint2, uint2, uint2), `exec_tuple_index3`)),
    PUSHPOW2: cat("int_const", mkfixedrangen(0x8300, 0x83ff, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_push_pow2`)),
    BLKPUSH: cat("stack", mkfixedrangen(0x5f10, 0x6000, 16, 8, (0, exports.seq)((0, exports.uint)(4, (0, exports.range)(1n, 15n)), (0, exports.stack)(4)), `exec_blkpush`)),
    BLKDROP2: cat("stack", mkfixedrangen(0x6c10, 0x6d00, 16, 8, (0, exports.seq)(uint4, uint4), `exec_blkdrop2`)),
    GETGLOB: cat("globals", mkfixedrangen(0xf841, 0xf860, 16, 5, (0, exports.seq)(uint5), `exec_get_global`)),
    SETGLOB: cat("globals", mkfixedrangen(0xf861, 0xf880, 16, 5, (0, exports.seq)(uint5), `exec_set_global`)),
    GETPARAM: cat("config", mkfixedrangen(0xf820, 0xf823, 16, 4, (0, exports.seq)(uint4), `exec_get_var_param`)),
    // SECTION: Ref instructions
    PUSHREF: cat("cell_const", mkext(0x88, 8, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_push_ref(_1, _2, 0, _4)`)),
    PUSHREFSLICE: effects(cat("cell_const", mkext(0x89, 8, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_push_ref(_1, _2, 1, _4)`)), (0, exports.CellLoad)()),
    PUSHREFCONT: effects(cat("cell_const", mkext(0x8a, 8, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_push_ref(_1, _2, 2, _4)`)), (0, exports.CellLoad)()),
    CALLREF: effects(cat("continuation_jump", mkext(0xdb3c, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_ref(_1, _2, _4, (st, cont) => st.call((cont)), 'CALLREF')`)), (0, exports.CellLoad)()),
    JMPREF: effects(cat("continuation_jump", mkext(0xdb3d, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_ref(_1, _2, _4, (st, cont) => st.jump((cont)), 'JMPREF')`)), (0, exports.CellLoad)()),
    JMPREFDATA: effects(cat("continuation_jump", mkext(0xdb3e, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_ref(_1, _2, _4, (st, cont) => { st.push_code(); return st.jump((cont)) }, 'JMPREFDATA')`)), (0, exports.CellLoad)()),
    IFREF: effects(cat("continuation_cond", mkext(0xe300, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_cell(1, _2, _4, (st, cell) => st.get_stack().pop_bool() ? st.call(st.ref_to_cont((cell))) : 0, 'IFREF')`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFNOTREF: effects(cat("continuation_cond", mkext(0xe301, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_cell(1, _2, _4, (st, cell) => st.get_stack().pop_bool() ? 0 : st.call(st.ref_to_cont((cell))), 'IFNOTREF')`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFJMPREF: effects(cat("continuation_cond", mkext(0xe302, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_cell(1, _2, _4, (st, cell) => st.get_stack().pop_bool() ? st.jump(st.ref_to_cont((cell))) : 0, 'IFJMPREF')`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFNOTJMPREF: effects(cat("continuation_cond", mkext(0xe303, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_do_with_cell(1, _2, _4, (st, cell) => st.get_stack().pop_bool() ? 0 : st.jump(st.ref_to_cont((cell))), 'IFNOTJMPREF')`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFREFELSE: effects(cat("continuation_cond", mkext(0xe30d, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_ifelse_ref(_1, _2, _4, true)`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFELSEREF: effects(cat("continuation_cond", mkext(0xe30e, 16, 0, (0, exports.seq)(exports.refCodeSlice), `(_1, _2, _3, _4) => exec_ifelse_ref(_1, _2, _4, false)`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFREFELSEREF: effects(cat("continuation_cond", mkext(0xe30f, 16, 0, (0, exports.seq)(exports.refCodeSlice, exports.refCodeSlice), `exec_ifref_elseref`)), (0, exports.CellLoad)()),
    IFBITJMPREF: effects(cat("continuation_cond", mkext(0xe3c >> 1, 11, 5, (0, exports.seq)(uint5, exports.refCodeSlice), `exec_if_bit_jmpref`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    IFNBITJMPREF: effects(cat("continuation_cond", mkext((0xe3c >> 1) | 0b1, 11, 5, (0, exports.seq)(uint5, exports.refCodeSlice), `exec_if_bit_jmpref`)), (0, exports.ImplicitJumpRef)(), (0, exports.CellLoad)()),
    // END SECTION
    DICTPUSHCONST: cat("dictionary", mkfixedn(0x3d29, 14, 10, (0, exports.seq)(exports.dict, uint10), `exec_push_const_dict`)),
    PFXDICTSWITCH: cat("dictionary", mkfixedn(0xf4ac00 >> 10, 14, 10, (0, exports.seq)(exports.dict, uint10), `exec_const_pfx_dict_switch`)),
    // SECTION: sdbegins
    ...
    SDBEGINS: cat("cell_deserialize", mkext(0xd728 >> 2, 14, 7, (0, exports.seq)((0, exports.slice)(uint0, uint7, 3)), `exec_slice_begins_with_const`)),
    SDBEGINSQ: cat("cell_deserialize", mkext(0xd72c >> 2, 14, 7, (0, exports.seq)((0, exports.slice)(uint0, uint7, 3)), `exec_slice_begins_with_const`)),
    // END SECTION
    STREFCONST: cat("cell_serialize", mkextrange(0xcf20, 0xcf21, 16, 0, (0, exports.seq)(exports.refCodeSlice), `exec_store_const_ref`)),
    STREF2CONST: cat("cell_serialize", mkextrange(0xcf21, 0xcf22, 16, 0, (0, exports.seq)(exports.refCodeSlice, exports.refCodeSlice), `exec_store_const_ref`)),
    THROWANYIF: effects(cat("exception", mksimple(0xf2f2, 16, `exec_throw_any`)), (0, exports.CanThrow)()),
    THROWARGANYIF: effects(cat("exception", mksimple(0xf2f3, 16, `exec_throw_any`)), (0, exports.CanThrow)()),
    DEBUGSTR: cat("debug", mkext(0xfef, 12, 4, (0, exports.seq)(exports.debugstr), `exec_dummy_debug_str`)),
    SETCONTCTR: cat("continuation_change", mkfixedrangen(0xed60, 0xed68, 16, 4, (0, exports.seq)(exports.control), `exec_setcont_ctr`)),
    SETRETCTR: cat("continuation_change", mkfixedrangen(0xed70, 0xed78, 16, 4, (0, exports.seq)(exports.control), `exec_setret_ctr`)),
    SETALTCTR: cat("continuation_change", mkfixedrangen(0xed80, 0xed88, 16, 4, (0, exports.seq)(exports.control), `exec_setalt_ctr`)),
    POPSAVE: cat("continuation_change", mkfixedrangen(0xed90, 0xed98, 16, 4, (0, exports.seq)(exports.control), `exec_popsave_ctr`)),
    SAVECTR: cat("continuation_change", mkfixedrangen(0xeda0, 0xeda8, 16, 4, (0, exports.seq)(exports.control), `exec_save_ctr`)),
    SAVEALTCTR: cat("continuation_change", mkfixedrangen(0xedb0, 0xedb8, 16, 4, (0, exports.seq)(exports.control), `exec_savealt_ctr`)),
    SAVEBOTHCTR: cat("continuation_change", mkfixedrangen(0xedc0, 0xedc8, 16, 4, (0, exports.seq)(exports.control), `exec_saveboth_ctr`)),
    RUNVM: version(4, cat("continuation_jump", mkfixedn(0xdb4, 12, 12, (0, exports.seq)((0, exports.uint)(12, { min: 0n, max: 511n })), `exec_runvm`))),
    ...
    "ADDRSHIFT#MOD": version(4, cat("div", mkfixedn(0xa930, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`))),
    "ADDRSHIFTR#MOD": version(4, cat("div", mkfixedn(0xa931, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`))),
    "ADDRSHIFTC#MOD": version(4, cat("div", mkfixedn(0xa932, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`))),
    "RSHIFT#": cat("div", mkfixedn(0xa934, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTR#": cat("div", mkfixedn(0xa935, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTC#": cat("div", mkfixedn(0xa936, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "MODPOW2#": cat("div", mkfixedn(0xa938, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "MODPOW2R#": cat("div", mkfixedn(0xa939, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "MODPOW2C#": cat("div", mkfixedn(0xa93a, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFT#MOD": cat("div", mkfixedn(0xa93c, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTR#MOD": cat("div", mkfixedn(0xa93d, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTC#MOD": cat("div", mkfixedn(0xa93e, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shrmod(_1, _2, 2)`)),
    "MULADDRSHIFT#MOD": version(4, cat("div", mkfixedn(0xa9b0, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`))),
    "MULADDRSHIFTR#MOD": version(4, cat("div", mkfixedn(0xa9b1, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`))),
    "MULADDRSHIFTC#MOD": version(4, cat("div", mkfixedn(0xa9b2, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`))),
    "MULRSHIFT#": cat("div", mkfixedn(0xa9b4, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTR#": cat("div", mkfixedn(0xa9b5, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTC#": cat("div", mkfixedn(0xa9b6, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULMODPOW2#": cat("div", mkfixedn(0xa9b8, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULMODPOW2R#": cat("div", mkfixedn(0xa9b9, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULMODPOW2C#": cat("div", mkfixedn(0xa9ba, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFT#MOD": cat("div", mkfixedn(0xa9bc, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTR#MOD": cat("div", mkfixedn(0xa9bd, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTC#MOD": cat("div", mkfixedn(0xa9be, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_mulshrmod(_1, _2, 2)`)),
    "LSHIFT#ADDDIVMOD": version(4, cat("div", mkfixedn(0xa9d0, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`))),
    "LSHIFT#ADDDIVMODR": version(4, cat("div", mkfixedn(0xa9d1, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`))),
    "LSHIFT#ADDDIVMODC": version(4, cat("div", mkfixedn(0xa9d2, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`))),
    "LSHIFT#DIV": cat("div", mkfixedn(0xa9d4, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVR": cat("div", mkfixedn(0xa9d5, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVC": cat("div", mkfixedn(0xa9d6, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#MOD": cat("div", mkfixedn(0xa9d8, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#MODR": cat("div", mkfixedn(0xa9d9, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#MODC": cat("div", mkfixedn(0xa9da, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVMOD": cat("div", mkfixedn(0xa9dc, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVMODR": cat("div", mkfixedn(0xa9dd, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVMODC": cat("div", mkfixedn(0xa9de, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_shldivmod(_1, _2, 2)`)),
    // special case: named argument
    HASHEXT: version(4, cat("crypto_common", mkfixedn(0xf904, 16, 8, (0, exports.seq)(hash), `exec_hash_ext`))),
    HASHEXTR: version(4, cat("crypto_common", mkfixedn(0xf905, 16, 8, (0, exports.seq)(hash), `exec_hash_ext`))),
    HASHEXTA: version(4, cat("crypto_common", mkfixedn(0xf906, 16, 8, (0, exports.seq)(hash), `exec_hash_ext`))),
    HASHEXTAR: version(4, cat("crypto_common", mkfixedn(0xf907, 16, 8, (0, exports.seq)(hash), `exec_hash_ext`))),
    ...
    XCHG3: cat("stack", mkfixedn(0x4, 4, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4), (0, exports.stack)(4)), `exec_xchg3`)),
    XCHG3_ALT: cat("stack", mkfixedn(0x540, 12, 12, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4), (0, exports.stack)(4)), `exec_xchg3`)),
    STI: cat("cell_serialize", mkfixedn(0xca, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int(_1, _2, true)`)),
    STI_ALT: cat("cell_serialize", mkfixedn(0xcf08, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    STU: cat("cell_serialize", mkfixedn(0xcb, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int(_1, _2, false)`)),
    STU_ALT: cat("cell_serialize", mkfixedn(0xcf09, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_store_int_fixed`)),
    LDI: cat("cell_deserialize", mkfixedn(0xd2, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed(_1, _2, 0)`)),
    LDI_ALT: cat("cell_deserialize", mkfixedn(0xd708, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    LDU: cat("cell_deserialize", mkfixedn(0xd3, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed(_1, _2, 1)`)),
    LDU_ALT: cat("cell_deserialize", mkfixedn(0xd709, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_int_fixed2`)),
    LDSLICE: cat("cell_deserialize", mkfixedn(0xd6, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_slice_fixed`)),
    LDSLICE_ALT: cat("cell_deserialize", mkfixedn(0xd71c, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_load_slice_fixed2`)),
    // special case: with or without arg
    LSHIFT_VAR: cat("shift_logic", mksimple(0xac, 8, `(_1) => exec_lshift(_1, false)`)),
    LSHIFT: cat("shift_logic", mkfixedn(0xaa, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_lshift_tinyint8(_1, _2, false)`)),
    QLSHIFT_VAR: cat("shift_logic", mksimple(0xb7ac, 16, `(_1) => exec_lshift(_1, true)`)),
    QLSHIFT: cat("shift_logic", mkfixedn(0xb7aa, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_lshift_tinyint8(_1, _2, true)`)),
    BCHKBITS_VAR: effects(cat("cell_serialize", mksimple(0xcf39, 16, `(_1) => exec_builder_chk_bits_refs(_1, 1)`)), (0, exports.CanThrow)()),
    BCHKBITS: effects(cat("cell_serialize", mkfixedn(0xcf38, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_builder_chk_bits(_1, _2, false)`)), (0, exports.CanThrow)()),
    BCHKBITSQ_VAR: cat("cell_serialize", mksimple(0xcf3d, 16, `(_1) => exec_builder_chk_bits_refs(_1, 5)`)),
    BCHKBITSQ: cat("cell_serialize", mkfixedn(0xcf3c, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_builder_chk_bits(_1, _2, true)`)),
    ...
    RSHIFT: cat("shift_logic", mkfixedn(0xab, 8, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_rshift_tinyint8(_1, _2, false)`)),
    ...
    QRSHIFT: cat("shift_logic", mkfixedn(0xb7ab, 16, 8, (0, exports.seq)((0, exports.delta)(1, uint8)), `exec_rshift_tinyint8(_1, _2, true)`)),
    QRSHIFT_ALT: cat("div", mksimple(0xb7a924, 24, `exec_shrmod(_1, _2, 1)`)),
    // special case: long and short versions
    CALLDICT: cat("continuation_dict_jump", mkfixedn(0xf0, 8, 8, (0, exports.seq)(uint8), `exec_calldict_short`)),
    CALLDICT_LONG: cat("continuation_dict_jump", mkfixedn(0xf10 >> 2, 10, 14, (0, exports.seq)(uint14), `exec_calldict`)),
    THROW_SHORT: effects(cat("exception", mkfixedn(0xf20 >> 2, 10, 6, (0, exports.seq)(uint6), `exec_throw_fixed(_1, _2, 63, 0)`)), (0, exports.AlwaysThrow)()),
    THROW: effects(cat("exception", mkfixedn(0xf2c0 >> 3, 13, 11, (0, exports.seq)(uint11), `exec_throw_fixed(_1, _2, 0x7ff, 0)`)), (0, exports.AlwaysThrow)()),
    THROWIF_SHORT: effects(cat("exception", mkfixedn(0xf24 >> 2, 10, 6, (0, exports.seq)(uint6), `exec_throw_fixed(_1, _2, 63, 3)`)), (0, exports.CanThrow)()),
    THROWIF: effects(cat("exception", mkfixedn(0xf2d0 >> 3, 13, 11, (0, exports.seq)(uint11), `exec_throw_fixed(_1, _2, 0x7ff, 3)`)), (0, exports.CanThrow)()),
    THROWIFNOT_SHORT: effects(cat("exception", mkfixedn(0xf28 >> 2, 10, 6, (0, exports.seq)(uint6), `exec_throw_fixed(_1, _2, 63, 2)`)), (0, exports.CanThrow)()),
    THROWIFNOT: effects(cat("exception", mkfixedn(0xf2e0 >> 3, 13, 11, (0, exports.seq)(uint11), `exec_throw_fixed(_1, _2, 0x7ff, 2)`)), (0, exports.CanThrow)()),
    PUSHINT_4: cat("int_const", mkfixedn(0x7, 4, 4, (0, exports.seq)(exports.tinyInt), `exec_push_tinyint4`)),
    PUSHINT_8: cat("int_const", mkfixedn(0x80, 8, 8, (0, exports.seq)(int8), `exec_push_tinyint8`)),
    PUSHINT_16: cat("int_const", mkfixedn(0x81, 8, 16, (0, exports.seq)(int16), `exec_push_smallint`)),
    PUSHINT_LONG: cat("int_const", mkextrange(0x820 << 1, (0x820 << 1) + 31, 13, 5, (0, exports.seq)(exports.largeInt), `exec_push_int`)),
    XCHG_0I_LONG: cat("stack", mkfixedn(0x11, 8, 8, (0, exports.seq)((0, exports.stack2)(8, 1n)), `exec_xchg0_l`)),
    XCHG_0I: cat("stack", mkfixedrangen(0x02, 0x10, 8, 4, (0, exports.seq)((0, exports.stack2)(4, 1n)), `exec_xchg0`)),
    XCHG_IJ: cat("stack", mkfixedn(0x10, 8, 8, (0, exports.seq)((0, exports.stack2)(4, 1n), (0, exports.stack)(4)), `exec_xchg`)),
    XCHG_1I: cat("stack", mkfixedrangen(0x12, 0x20, 8, 4, (0, exports.seq)(exports.s1, (0, exports.stack2)(4, 2n)), `exec_xchg1`)),
    // special case: opcode with holes
    DUMPSTK: cat("debug", mksimple(0xfe00, 16, `exec_dump_stack`)),
    DEBUG: cat("debug", mkfixedrangen(0xfe01, 0xfe14, 16, 8, (0, exports.seq)(uint8), `exec_dummy_debug`)),
    STRDUMP: cat("debug", mksimple(0xfe14, 16, `exec_dump_string`)),
    DEBUG_1: cat("debug", mkfixedrangen(0xfe15, 0xfe20, 16, 8, (0, exports.seq)(uint8), `exec_dummy_debug`)),
    DUMP: cat("debug", mkfixedn(0xfe2, 12, 4, (0, exports.seq)((0, exports.stack)(4)), `exec_dump_value`)),
    DEBUG_2: cat("debug", mkfixedrangen(0xfe30, 0xfef0, 16, 8, (0, exports.seq)(uint8), `exec_dummy_debug`)),
    PUSHCTR: cat("continuation_change", mkfixedrangen(0xed40, 0xed48, 16, 4, (0, exports.seq)(exports.control), `exec_push_ctr`)),
    PUSH: cat("stack", mkfixedrangen(0x22, 0x30, 8, 4, (0, exports.seq)((0, exports.stack)(4)), `exec_push`)),
    PUSH_LONG: cat("stack", mkfixedn(0x56, 8, 8, (0, exports.seq)((0, exports.stack)(8)), `exec_push_l`)),
    POPCTR: cat("continuation_change", mkfixedrangen(0xed50, 0xed58, 16, 4, (0, exports.seq)(exports.control), `exec_pop_ctr`)),
    POP: cat("stack", mkfixedrangen(0x32, 0x40, 8, 4, (0, exports.seq)((0, exports.stack)(4)), `exec_pop`)),
    POP_LONG: cat("stack", mkfixedn(0x57, 8, 8, (0, exports.seq)((0, exports.stack)(8)), `exec_pop_l`)),
    CALLXARGS: cat("continuation_jump", mkfixedn(0xdb0, 12, 4, (0, exports.seq)(uint4, exports.minusOne), `exec_callx_args_p`)),
    CALLXARGS_1: cat("continuation_jump", mkfixedn(0xda, 8, 8, (0, exports.seq)(uint4, uint4), `exec_callx_args`)),
    PUSHSLICE: cat("cell_const", mkext(0x8b, 8, 4, (0, exports.seq)((0, exports.slice)(uint0, uint4, 4)), `exec_push_slice`)),
    PUSHSLICE_REFS: cat("cell_const", mkext(0x8c, 8, 7, (0, exports.seq)((0, exports.slice)((0, exports.delta)(1, uint2), uint5, 1)), `exec_push_slice_r`)),
    PUSHSLICE_LONG: cat("cell_const", mkextrange((0x8d << 3) << 7, ((0x8d << 3) + 5) << 7, 18, 10, (0, exports.seq)((0, exports.slice)(uint3, uint7, 6)), `exec_push_slice_r2`)),
    PUSHCONT: cat("cell_const", mkext(0x8e >> 1, 7, 9, (0, exports.seq)((0, exports.codeSlice)(uint2, uint7)), `exec_push_cont`)),
    PUSHCONT_SHORT: cat("cell_const", mkext(0x9, 4, 4, (0, exports.seq)((0, exports.inlineCodeSlice)(uint4)), `exec_push_cont_simple`)),
    STSLICECONST: cat("cell_serialize", mkext(0xcf80 >> 7, 9, 5, (0, exports.seq)((0, exports.slice)(uint2, uint3, 2)), `exec_store_const_slice`)),
    SETCP: cat("codepage", mkfixedrangen(0xff00, 0xfff0, 16, 8, (0, exports.seq)(uint8), `exec_set_cp`)),
    SETCPX: cat("codepage", mksimple(0xfff0, 16, `exec_set_cp_any`)),
    SETCP_SHORT: cat("codepage", mkfixedrangen(0xfff1, 0x10000, 16, 8, (0, exports.seq)((0, exports.delta)(-256, uint8)), `exec_set_cp`)),
    // SETCP: cat("codepage", mkfixedrangen(0xff00, 0x10000, 16, 8, seq(setcpArg), `exec_set_cp`)),
    PSEUDO_PUSHREF: cat("cell_const", mkfixedpseudo(0, (0, exports.seq)(exports.refCodeSlice))),
    PSEUDO_PUSHSLICE: cat("cell_const", mkfixedpseudo(0, (0, exports.seq)((0, exports.slice)(uint0, (0, exports.uint)(0, (0, exports.range)(0n, 0n)), 0)))),
    PSEUDO_EXOTIC: cat("cell_const", mkfixedpseudo(0, (0, exports.seq)(exports.exoticCell))),
    // TVM 11 instructions
    GETPARAMLONG: version(11, cat("config", mkfixedrangen(0xf88100, 0xf88111, 24, 8, (0, exports.seq)(uint8), `exec_get_var_param_long`))),
    INMSGPARAMS: version(11, cat("config", mksimple(0xf88111, 24, `exec_get_param`))),
    GETPARAMLONG2: version(11, cat("config", mkfixedrangen(0xf88112, 0xf881ff, 24, 8, (0, exports.seq)(uint8), `exec_get_var_param_long`))),
    ...
    INMSGPARAM: version(11, cat("config", mkfixedrangen(0xf89a, 0xf8a0, 16, 4, (0, exports.seq)(uint4), `exec_get_var_in_msg_param`))),
    // TVM 12 instructions
    ...
    DEBUGMARK: cat("int_const", mkfixedn(0xF955, 16, 16, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 0n))), `exec_push_pow2dec`)),
    fPUSHSLICE: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.slice)(uint4, uint4, 0)), "")),
    fPUSHCONT: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.codeSlice)(uint4, uint4)), "")),
    fSTSLICECONST: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.slice)(uint2, uint3, 2)), "")),
    fXCHG: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.stack)(4), (0, exports.stack)(4)), "")),
    fPUSHINTX: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)(exports.largeInt), "")),
    fSDBEGINS: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.slice)(uint4, uint4, 0)), "")),
    fSDBEGINSQ: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.slice)(uint4, uint4, 0)), "")),
    fCALLXARGS: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)(uint4, (0, exports.int)(8, (0, exports.range)(-1n, 15n))), "")),
    fCALLDICT: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 16383n))), "")),
    fJMPDICT: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 16383n))), "")),
    fPREPAREDICT: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 16383n))), "")),
    fTHROW: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 2047n))), "")),
    fTHROWIF: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 2047n))), "")),
    fTHROWIFNOT: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)((0, exports.uint)(16, (0, exports.range)(0n, 2047n))), "")),
    fIF: cat("int_const", mkfixedn(0, 0, 0, (0, exports.seq)(exports.largeInt, (0, exports.codeSlice)(uint4, uint4), (0, exports.codeSlice)(uint4, uint4)), "")),
};
exports.pseudoInstructions = new Set([
    "PSEUDO_PUSHSLICE",
    "PSEUDO_PUSHREF",
    "PSEUDO_EXOTIC",
]);
const instructionList = () => {
    return Object.entries(exports.instructions).filter(([name]) => !name.startsWith("f")).map(([rawName, opcode]) => {
...
const fiftInstructionList = () => {
    return [
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fPUSHINT", (0, exports.infoOf)("PUSHINT_LONG")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fPUSHSLICE", (0, exports.infoOf)("fPUSHSLICE")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fPUSHCONT", (0, exports.infoOf)("fPUSHCONT")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fSTSLICECONST", (0, exports.infoOf)("fSTSLICECONST")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fXCHG", (0, exports.infoOf)("fXCHG")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fPUSHINTX", (0, exports.infoOf)("fPUSHINTX")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fSDBEGINS", (0, exports.infoOf)("fSDBEGINS")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fSDBEGINSQ", (0, exports.infoOf)("fSDBEGINSQ")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fCALLXARGS", (0, exports.infoOf)("fCALLXARGS")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fCALLDICT", (0, exports.infoOf)("fCALLDICT")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fJMPDICT", (0, exports.infoOf)("fJMPDICT")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fPREPAREDICT", (0, exports.infoOf)("fPREPAREDICT")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fTHROW", (0, exports.infoOf)("fTHROW")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fTHROWIF", (0, exports.infoOf)("fTHROWIF")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fTHROWIFNOT", (0, exports.infoOf)("fTHROWIFNOT")],
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ["fIF", (0, exports.infoOf)("fIF")],
    ];
};
exports.fiftInstructionList = fiftInstructionList;
const infoOf = (name) => {
    return exports.instructions[name];
};
exports.infoOf = infoOf;
exports.COST_PER_BIT = 1;
exports.COST_PER_TUPLE_ITEM = 1;
exports.MAX_TUPLE_ITEMS = 15;
exports.COST_PRELOAD_INSTR = 10;
const calculateGasConsumption = (instr) => {
    const base = instr.skipLen * exports.COST_PER_BIT + exports.COST_PRELOAD_INSTR;
    const result = [base];
...
exports.calculateGasConsumption = calculateGasConsumption;
const calculateGasConsumptionWithDescription = (instr) => {
    const base = instr.skipLen * exports.COST_PER_BIT + exports.COST_PRELOAD_INSTR;
    if (!instr.effects || instr.effects.length === 0) {
        return [{
                value: base,
...
exports.calculateGasConsumptionWithDescription = calculateGasConsumptionWithDescription;
