...
export declare const BTOS: $.Type<c.BTOS>;
export declare const HASHBU: $.Type<c.HASHBU>;
export declare const LDSTDADDR: $.Type<c.LDSTDADDR>;
export declare const LDSTDADDRQ: $.Type<c.LDSTDADDRQ>;
export declare const LDOPTSTDADDR: $.Type<c.LDOPTSTDADDR>;
export declare const LDOPTSTDADDRQ: $.Type<c.LDOPTSTDADDRQ>;
export declare const STSTDADDR: $.Type<c.STSTDADDR>;
export declare const STSTDADDRQ: $.Type<c.STSTDADDRQ>;
export declare const STOPTSTDADDR: $.Type<c.STOPTSTDADDR>;
export declare const STOPTSTDADDRQ: $.Type<c.STOPTSTDADDRQ>;
