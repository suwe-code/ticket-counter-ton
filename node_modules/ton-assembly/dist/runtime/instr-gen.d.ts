...
export declare const rangeToType: ({
    ...
    min: number;
    max: number;
    load: $.Load<c.PUSHSLICE_REFS>;
} | {
    min: number;
    max: number;
    load: $.Load<c.PUSHSLICE_LONG>;
} | {
    min: number;
    max: number;
    ...
    min: number;
    max: number;
    load: $.Load<c.GETPARAMLONG>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSGPARAMS>;
} | {
    min: number;
    max: number;
    load: $.Load<c.GETPARAMLONG2>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_BOUNCE>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_BOUNCED>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_SRC>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_FWDFEE>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_LT>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_UTIME>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_ORIGVALUE>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_VALUE>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_VALUEEXTRA>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSG_STATEINIT>;
} | {
    min: number;
    max: number;
    load: $.Load<c.INMSGPARAM>;
} | {
    min: number;
    max: number;
    load: $.Load<c.BTOS>;
    ...
    min: number;
    max: number;
    load: $.Load<c.LDSTDADDR>;
} | {
    min: number;
    max: number;
    load: $.Load<c.LDSTDADDRQ>;
} | {
    min: number;
    max: number;
    load: $.Load<c.LDOPTSTDADDR>;
} | {
    min: number;
    max: number;
    load: $.Load<c.LDOPTSTDADDRQ>;
} | {
    min: number;
    max: number;
    load: $.Load<c.STSTDADDR>;
} | {
    min: number;
    max: number;
    load: $.Load<c.STSTDADDRQ>;
} | {
    min: number;
    max: number;
    load: $.Load<c.STOPTSTDADDR>;
} | {
    min: number;
    max: number;
    load: $.Load<c.STOPTSTDADDRQ>;
} | {
    min: number;
    max: number;
...
//# sourceMappingURL=instr-gen.d.ts.map