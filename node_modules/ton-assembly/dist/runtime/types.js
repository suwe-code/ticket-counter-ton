...
exports.ADDINT = {
    ...
    store: (b, val, options) => {
        ...
        $.int(8).store(b, val.arg0, options);
    },
};
exports.MULINT = {
    load: s => {
...
exports.PUSHPOW2DEC = {
    ...
    store: (b, val, options) => {
        ...
        $.delta(1, $.uint(8)).store(b, val.arg0, options);
    },
};
exports.PUSHNEGPOW2 = {
    load: s => {
...
exports.CALLCCARGS = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(4).store(b, val.arg1, options);
    },
};
exports.TRYARGS = {
    load: s => {
...
exports.PLDREFIDX = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(2).store(b, val.arg0, options);
    },
};
exports.CHASHI = {
    load: s => {
...
exports.JMPDICT = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(14).store(b, val.arg0, options);
    },
};
exports.PREPAREDICT = {
    load: s => {
...
exports.THROWARG = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(11).store(b, val.arg0, options);
    },
};
exports.THROWARGIF = {
    load: s => {
...
exports.XC2PU = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(4).store(b, val.arg0, options);
        $.uint(4).store(b, val.arg1, options);
        $.uint(4).store(b, val.arg2, options);
    },
};
exports.XCPU2 = {
    load: s => {
...
exports.PUXC = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(4).store(b, val.arg0, options);
        $.delta(-1, $.uint(4)).store(b, val.arg1, options);
    },
};
exports.XCPUXC = {
    load: s => {
    ...
    store: (b, val, options) => {
        ...
        $.uint(4).store(b, val.arg0, options);
        $.uint(4).store(b, val.arg1, options);
        $.delta(-1, $.uint(4)).store(b, val.arg2, options);
    },
};
exports.PUXC2 = {
    load: s => {
...
exports.PU2XC = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(4).store(b, val.arg0, options);
        $.delta(-1, $.uint(4)).store(b, val.arg1, options);
        $.delta(-2, $.uint(4)).store(b, val.arg2, options);
    },
};
exports.BLKSWAP = {
    load: s => {
    ...
    store: (b, val, options) => {
        ...
        $.delta(1, $.uint(4)).store(b, val.arg0, options);
        $.delta(1, $.uint(4)).store(b, val.arg1, options);
    },
};
exports.REVERSE = {
    ...
    store: (b, val, options) => {
        ...
        $.delta(2, $.uint(4)).store(b, val.arg0, options);
        $.uint(4).store(b, val.arg1, options);
    },
};
exports.SETCONTARGS = {
...
exports.PLDUZ = {
    ...
    store: (b, val, options) => {
        ...
        $.plduzArg.store(b, val.arg0, options);
    },
};
exports.PLDSLICE = {
    load: s => {
...
exports.IFBITJMP = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(5).store(b, val.arg0, options);
    },
};
exports.IFNBITJMP = {
    load: s => {
...
exports.INDEX2 = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(2).store(b, val.arg0, options);
        $.uint(2).store(b, val.arg1, options);
    },
};
exports.INDEX3 = {
    load: s => {
    ...
    store: (b, val, options) => {
        ...
        $.uint(2).store(b, val.arg0, options);
        $.uint(2).store(b, val.arg1, options);
        $.uint(2).store(b, val.arg2, options);
    },
};
exports.PUSHPOW2 = {
    load: s => {
...
exports.PUSHREF = {
    ...
    store: (b, val, options) => {
        ...
        $.refCodeSlice.store(b, val.arg0, options);
    },
};
...
exports.IFREFELSEREF = {
    ...
    store: (b, val, options) => {
        ...
        $.refCodeSlice.store(b, val.arg0, options);
        $.refCodeSlice.store(b, val.arg1, options);
    },
};
exports.IFBITJMPREF = {
    load: s => {
...
exports.DICTPUSHCONST = {
    ...
    store: (b, val, options) => {
        ...
        $.dictpush.store(b, [val.arg0, val.arg1], options);
    },
};
...
exports.DEBUGSTR = {
    ...
    store: (b, val, options) => {
        ...
        $.debugstr.store(b, val.arg0, options);
    },
};
exports.SETCONTCTR = {
    load: s => {
    ...
    store: (b, val, options) => {
        ...
        $.control.store(b, val.arg0, options);
    },
};
exports.SETRETCTR = {
    load: s => {
...
exports.LSHIFT = {
    load: s => {
        s.skip(8);
        return c.LSHIFT($.delta(1, $.uint(8)).load(s));
    },
    store: (b, val, options) => {
...
exports.QLSHIFT = {
    load: s => {
        s.skip(16);
        return c.QLSHIFT($.delta(1, $.uint(8)).load(s));
    },
    store: (b, val, options) => {
...
exports.BCHKBITS_VAR = {
    load: s => {
        s.skip(16);
        return c.BCHKBITS_VAR();
    },
    store: (b, val, options) => {
...
exports.BCHKBITS = {
    load: s => {
        s.skip(16);
        return c.BCHKBITS($.delta(1, $.uint(8)).load(s));
    },
    store: (b, val, options) => {
...
exports.BCHKBITSQ_VAR = {
    load: s => {
        s.skip(16);
        return c.BCHKBITSQ_VAR();
    },
    store: (b, val, options) => {
...
exports.BCHKBITSQ = {
    load: s => {
        s.skip(16);
        return c.BCHKBITSQ($.delta(1, $.uint(8)).load(s));
    },
    store: (b, val, options) => {
...
exports.RSHIFT = {
    load: s => {
        s.skip(8);
        return c.RSHIFT($.delta(1, $.uint(8)).load(s));
    },
    store: (b, val, options) => {
...
exports.QRSHIFT = {
    load: s => {
        s.skip(16);
        return c.QRSHIFT($.delta(1, $.uint(8)).load(s));
    },
    store: (b, val, options) => {
...
exports.THROW_SHORT = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(6).store(b, val.arg0, options);
    },
};
exports.THROW = {
    load: s => {
...
exports.PUSHINT_4 = {
    load: s => {
        s.skip(4);
        return c.PUSHINT_4($.tinyInt.load(s));
    },
    store: (b, val, options) => {
        b.storeInstructionPrefix(7, 4, val);
        $.tinyInt.store(b, val.arg0, options);
    },
};
exports.PUSHINT_8 = {
    load: s => {
...
exports.PUSHINT_16 = {
    ...
    store: (b, val, options) => {
        ...
        $.int(16).store(b, val.arg0, options);
    },
};
...
exports.XCHG_0I = {
    load: s => {
        s.skip(4);
        return c.XCHG_0I($.uint(4).load(s));
    },
    store: (b, val, options) => {
...
exports.XCHG_IJ = {
    load: s => {
        s.skip(8);
        return c.XCHG_IJ($.uint(4).load(s), $.uint(4).load(s));
    },
    store: (b, val, options) => {
...
exports.XCHG_1I = {
    load: s => {
        s.skip(4);
        return c.XCHG_1I($.s1.load(s), $.uint(4).load(s));
    },
    store: (b, val, options) => {
        b.storeInstructionPrefix(18 >> 4, 4, val);
        $.s1.store(b, val.arg0, options);
        $.uint(4).store(b, val.arg1, options);
    },
};
exports.DUMPSTK = {
...
exports.CALLXARGS = {
    ...
    store: (b, val, options) => {
        ...
        $.uint(4).store(b, val.arg0, options);
        $.minusOne.store(b, val.arg1, options);
    },
};
exports.CALLXARGS_1 = {
    load: s => {
...
exports.PUSHSLICE_REFS = {
    load: s => {
        s.skip(8);
        return c.PUSHSLICE_REFS($.slice($.delta(1, $.uint(2)), $.uint(5), 1).load(s));
    },
    store: (b, val, options) => {
        b.storeInstructionPrefix(140, 8, val);
        $.slice($.delta(1, $.uint(2)), $.uint(5), 1).store(b, val.arg0, options);
    },
};
exports.PUSHSLICE_LONG = {
    load: s => {
        s.skip(8);
        return c.PUSHSLICE_LONG($.slice($.uint(3), $.uint(7), 6).load(s));
    },
    store: (b, val, options) => {
        b.storeInstructionPrefix(144384 >> 10, 8, val);
        $.slice($.uint(3), $.uint(7), 6).store(b, val.arg0, options);
    },
};
exports.PUSHCONT = {
    load: s => {
    ...
    store: (b, val, options) => {
        ...
        $.codeSlice($.uint(2), $.uint(7)).store(b, val.arg0, options);
    },
};
exports.PUSHCONT_SHORT = {
    ...
    store: (b, val, options) => {
        ...
        $.inlineCodeSlice($.uint(4)).store(b, val.arg0, options);
    },
};
exports.STSLICECONST = {
    ...
    store: (b, val, options) => {
        ...
        $.slice($.uint(2), $.uint(3), 2).store(b, val.arg0, options);
    },
};
exports.SETCP = {
    load: s => {
...
exports.SETCP_SHORT = {
    ...
    store: (b, val, options) => {
        ...
        $.delta(-256, $.uint(8)).store(b, val.arg0, options);
    },
};
exports.GETPARAMLONG = {
    load: s => {
        s.skip(16);
